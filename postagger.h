...
/*
tagset obtained from:
    https://github.com/languagetool-org/languagetool/blob/master/languagetool-language-modules/en/src/main/resources/org/languagetool/resource/en/tagset.txt
...
public:
    ...
    int buildDict();
    //void tag(vector<string>&, vector<pair<string, POS>>&);

private:
    //map<string, map<POS, int> results;
